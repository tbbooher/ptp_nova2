...
+function(t) {
    ...
    e.DEFAULTS = {
        ...
        t += "Text", n.resetText || i.data("resetText", i[o]()), i[o](n[t] || this.options[t]), 
        setTimeout(function() {
    ...
    t.fn.carousel = function(i) {
        return this.each(function() {
            var o = t(this), n = o.data("bs.carousel"), s = t.extend({}, e.DEFAULTS, o.data(), "object" == typeof i && i), a = "string" == typeof i ? i :s.slide;
    ...
    e.DEFAULTS = {
        ...
        if (!this.transitioning && !this.$element.hasClass("in")) {
            ...
            if (this.$element.trigger(e), !e.isDefaultPrevented()) {
                ...
                var s = function() {
                    this.$element.removeClass("collapsing").addClass("in")[n]("auto"), this.transitioning = 0, 
        ...
        if (!this.transitioning && this.$element.hasClass("in")) {
            ...
            if (this.$element.trigger(e), !e.isDefaultPrevented()) {
                ...
                return t.support.transition ? (this.$element[i](0).one(t.support.transition.end, t.proxy(o, this)).emulateTransitionEnd(350), 
                void 0) :o.call(this);
            }
        }
    }, e.prototype.toggle = function() {
    ...
    t.fn.collapse = function(i) {
        return this.each(function() {
            var o = t(this), n = o.data("bs.collapse"), s = t.extend({}, e.DEFAULTS, o.data(), "object" == typeof i && i);
    ...
    s.prototype.toggle = function(o) {
        ...
        if (!n.is(".disabled, :disabled")) {
            ...
            if (e(), !a) {
                ...
                s.trigger(o = t.Event("show.bs.dropdown")), o.isDefaultPrevented()) return;
        ...
        if (/(38|40|27)/.test(e.keyCode)) {
            ...
            if (e.preventDefault(), e.stopPropagation(), !o.is(".disabled, :disabled")) {
                ...
                if (r.length) {
                    ...
                    38 == e.keyCode && l > 0 && l--, 40 == e.keyCode && l < r.length - 1 && l++, ~l || (l = 0), 
                    r.eq(l).focus();
                }
            }
        }
    ...
    e.DEFAULTS = {
        ...
        this.backdrop(function() {
            ...
            i.$element.parent().length || i.$element.appendTo(document.body), i.$element.show(), 
    ...
    t.fn.modal = function(i, o) {
        ...
        var i = t(this), o = i.attr("href"), n = t(i.attr("data-target") || o && o.replace(/.*(?=#[^\s]+$)/, "")), s = n.data("modal") ? "toggle" :t.extend({
            remote:!/#/.test(o) && o
        }, n.data(), i.data());
    ...
    e.DEFAULTS = {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            var o = "function" == typeof this.options.placement ? this.options.placement.call(this, i[0], this.$element[0]) :this.options.placement, n = /\s?auto?\s?/i, s = n.test(o);
            ...
            if (s) {
                var h = this.$element.parent(), p = o, d = document.documentElement.scrollTop || document.body.scrollTop, c = "body" == this.options.container ? window.innerWidth :h.outerWidth(), f = "body" == this.options.container ? window.innerHeight :h.outerHeight(), u = "body" == this.options.container ? 0 :h.offset().left;
        ...
        isNaN(a) && (a = 0), isNaN(r) && (r = 0), t.top = t.top + a, t.left = t.left + r, 
        o.offset(t).addClass("in");
        var l = o[0].offsetWidth, h = o[0].offsetHeight;
        if ("top" == e && h != s && (i = !0, t.top = t.top + s - h), /bottom|top/.test(e)) {
            var p = 0;
            t.left < 0 && (p = -2 * t.left, t.left = 0, o.offset(t), l = o[0].offsetWidth, h = o[0].offsetHeight), 
        ...
        return this.$element.trigger(n), n.isDefaultPrevented() ? void 0 :(o.removeClass("in"), 
    ...
    function e(i, o) {
        ...
        this.$element = t(i).is("body") ? t(window) :t(i), this.$body = t("body"), this.$scrollElement = this.$element.on("scroll.bs.scroll-spy.data-api", s), 
    ...
    e.DEFAULTS = {
        ...
        this.$body.find(this.selector).map(function() {
            var o = t(this), n = o.data("target") || o.attr("href"), s = /^#\w/.test(n) && t(n);
    ...
    e.prototype.show = function() {
        var e = this.element, i = e.closest("ul:not(.dropdown-menu)"), o = e.attr("data-target");
    ...
    var e = function(i, o) {
        ...
        this.$element = t(i), this.affixed = this.unpin = null, this.checkPosition();
    };
    e.RESET = "affix affix-top affix-bottom", e.DEFAULTS = {
        ...
        if (this.$element.is(":visible")) {
            ...
            this.unpin = "bottom" == l ? n.top - o :null, this.$element.removeClass(e.RESET).addClass("affix" + (l ? "-" + l :"")), 
